/*!
 * @file
 * @brief Interface for an MQTT client used by the GEA2 polling bridge.
 *
 * Vendored from geappliances/home-assistant-bridge (include/i_mqtt_client.h)
 * to avoid pulling in the full home-assistant-bridge library, which has
 * Arduino-only source files that conflict with the ESP-IDF build.
 */
