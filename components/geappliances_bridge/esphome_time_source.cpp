/*!
 * @file
 * @brief ESPHome time source implementation.
 *
 * Returns the current time in milliseconds via esphome::millis(), which works
 * correctly with both Arduino and ESP-IDF frameworks.
 */
